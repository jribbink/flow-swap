...
export default () => {
  const addLiquidityUrl = Token.generateAddLiquidityUrl(
    config.pairs[0].tokenA,
    config.pairs[0].tokenB
  );
    ...
    <div className="mx-auto w-100" style={{ maxWidth: '500px' }}>
      <div className="d-flex flex-row align-items-end px-2">
        ...
        <Link href={addLiquidityUrl}>
          <button className="btn btn-success shadow-none py-1 px-2 ms-auto">
            Add +
          </button>
        </Link>
      </div>
