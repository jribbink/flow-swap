...
export default ({ tokenA, tokenB }: AddLiquidityContainerProps) => {
  ...
  function updateTokenAmounts(
    ...
    setOtherAmount(
      quoteMarketValue(changedAmount, poolAmounts, tokenA, tokenB)
    );
  }

  useEffect(
    () => updateTokenAmounts(amountA, setAmountB, false),
  ...
  function buttonDisabledText() {
    ...
    else if (amountA > balanceA || amountB > balanceB)
  ...
  return (
    <div
      className="mx-auto bg-white rounded-4 p-4"
