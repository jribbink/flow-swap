  ...
  return (
    <div className="d-flex flex-column bg-secondary bg-opacity-25 p-4">
      <div className="d-flex align-items-end mb-3">
        ...
        <button
          className="btn btn-link p-0 shadow-none ms-auto text-decoration-none"
      ...
      {transactions.length > 0 ? (
        ...
        <div>Your recent transactions will appear here...</div>
      )}
    </div>
  );
};
...
const TransactionListItem = ({ transaction }: { transaction: Transaction }) => {
  ...
  return (
    <div className="d-flex flex-row align-items-center">
      <a
        className="btn btn-link text-decoration-none shadow-none p-0"
        href={generateFlowscanURL({ transactionId: transaction.id })}
      >
